...
$sql = "SELECT DISTINCT image, title, genre FROM movies ORDER BY id ASC LIMIT 16 OFFSET :offset";  
...
<div class="movie-container">
  <?php if (!empty($movies)): ?>
    <?php foreach ($movies as $movie): ?>
      ...
      if (!in_array($movie['image'], $displayedPosters)) {
          $displayedPosters[] = $movie['image']; 
      ?>
...
<div class="buttonat">
  ...
  <button class="page page3 highlighted">3</button>
